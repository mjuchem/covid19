...
grid.arrange(
  ...
  ggplot(mapping = aes(x = date)) +
    ...
    geom_line(aes(y = hospitalizedIncrease, color = "Hospitalized")) +
    geom_line(aes(y = positiveIncrease, color = "Positive")) +
...
grid.arrange(
  ...
  t_us_covidtracking %>%
    ...
    geom_line(aes(y = hospitalized, color = "Hospitalized"), na.rm = TRUE) +
...
t_us_covidtracking %>%
  ...
  ggplot(aes(x = week, y = hospitalizedIncrease)) +
  geom_col(fill = "grey", color = "white") +
  geom_ma(ma_fun = EMA, n = 4, size = 2, linetype = "solid", color = "orange", alpha = .3) +
  geom_ma(ma_fun = EMA, n = 8, size = 2, linetype = "solid", color = "purple", alpha = .3) +
  labs(
    title = "US COVID-19 Weekly Hospitalizations",
    subtitle = "Trends: Orange=EMA(4 weeks), Purple=EMA(8 weeks)",
    x = "Week",
